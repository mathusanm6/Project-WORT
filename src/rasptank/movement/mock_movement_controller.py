...
class MockMovementController(BaseMovementController):
    ...
    def __init__(self, simulation_speed_factor=1.0):
        ...
        self.max_speed = (
            0.5 * simulation_speed_factor
        )  # meters per second at 100% speed
        self.max_turn_rate = (
            90.0 * simulation_speed_factor
        )  # degrees per second at 100% turn
    ...
    def _validate_movement_params(
        self, thrust_direction, turn_direction, speed, turn_factor
    ):
    ...
    def timed_move(
        self, thrust_direction, turn_direction, speed, turn_factor, duration
    ):
        ...
        with self.timer_lock:
            ...
            timer = threading.Timer(
                duration, self._timed_move_callback, args=[timer_id]
            )
